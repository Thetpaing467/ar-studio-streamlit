...
# ============================================================
# Step 2: VoxCPM2 TTS — hgghfhjfhjguyjf/Voxcpm-Burmese-Tts
# ============================================================
...
def voxcpm_tts(text, workdir, ref_audio_path, ref_text="",
    ...
    VoxCPM2 Burmese TTS
    Endpoint: /tts
    Params: target_text, ref_audio, ref_text, cfg_value, inference_timesteps
    """
    ...
    for i, chunk in enumerate(chunks):
        ...
        shutil.copy(audio_path, str(chunk_path))
    ...
    return voice_out, None   # SRT — fallback သုံး
